...
double imu9250::fixAngle(double angle){
	if (angle <= -180){
		return angle + 360;
	}else if(angle > 180){
		return angle - 360;
...
double* imu9250::getRollPitchYaw(void){
	return rpy;
}
